...
!(async () => {
    ...
    let res = [], res2 = [], res3 = [];
    res = await getAuthorShareCode('https://raw.githubusercontent.com/paopaoya/up/main/jd_zoo.json');
    res2 = await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.com/paopaoya/up/main/jd_zoo.json');
